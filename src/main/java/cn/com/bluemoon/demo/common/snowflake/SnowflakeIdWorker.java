...
import cn.com.bluemoon.demo.util.DateUtils;
...
public class SnowflakeIdWorker {
	...
	public Map parseInfo(String id) {
	...
	public static void main(String[] args) {
        ...
        id = 509774412494020608L;
        Map json = idWorker.parseInfo(String.valueOf(id));
    }
}